...
class Pessoa:
    ...
    def apresentar(self):
        print(f"\nOlá, me chamo {self.nome} e tenho {self.idade} anos.")
...
class Estudante(Pessoa):
    ...
    def apresentar(self):
        print(f"\nOlá! Me chamo {self.nome}, tenho {self.idade} anos e faço o curso de {self.curso}.")


pessoa = Pessoa("Juquinha", 19)
estudante = Estudante("Joseina", 25, "Psicologia")


lista_objeto:list[Pessoa] = [pessoa, estudante]
